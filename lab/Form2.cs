...
namespace lab
{
    public partial class StudentsForm : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "jurnallabDataSet.Список_группы". При необходимости она может быть перемещена или удалена.
            this.список_группыTableAdapter.Fill(this.jurnallabDataSet.Список_группы);
